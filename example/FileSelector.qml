Widget {
    ...
    function layout(l) {
        ...
        favs       = ch[4]
        add_favs   = ch[5]
        l.fixed(sel_folder, selfBox, ff_x,   ff_y,  ff_w,   ff_h)
        l.fixed(sel_column, selfBox, ff_x2,  ff_y,  ff_w,   ff_h)
        l.fixed(line,       selfBox, top_x,  top_y, top_w,  top_h)
        l.fixed(select,     selfBox, top_x2, top_y, top_w2, top_h)
        l.fixed(favs,       selfBox, fv_x,   fv_y,  fv_w,   fv_h)
        l.fixed(add_favs,   selfBox, fv_x2,  fv_y,  fv_w2,  fv_h)
        selfBox
    }
